...
import de.openknowledge.archetype.base.infrastructure.validation.ValidationErrorDTO;
...
public class ValidationExceptionMapper implements ExceptionMapper<ConstraintViolationException> {
  ...
  public Response toResponse(final ConstraintViolationException e) {
    ...
    GenericEntity<List<ValidationErrorDTO>> entity = new GenericEntity<List<ValidationErrorDTO>>(errors) {
    };
