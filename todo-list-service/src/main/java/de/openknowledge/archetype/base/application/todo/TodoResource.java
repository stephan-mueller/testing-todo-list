...
import de.openknowledge.archetype.base.domain.todo.Todo;
import de.openknowledge.archetype.base.domain.todo.TodoRepository;
import de.openknowledge.archetype.base.infrastructure.domain.entity.EntityNotFoundException;
import de.openknowledge.archetype.base.infrastructure.domain.error.ApplicationErrorDTO;
...
public class TodoResource {
  ...
  @POST
  @Transactional
  @Operation(description = "CreateTodoValidationGroup a new todo")
  @APIResponses({
  ...
  public Response createTodo(
    ...
    LOG.info("CreateTodoValidationGroup todo {}", newTodo);
