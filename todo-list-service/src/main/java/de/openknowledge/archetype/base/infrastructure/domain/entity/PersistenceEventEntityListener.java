 ...
 */
package de.openknowledge.archetype.base.infrastructure.domain.entity;

import de.openknowledge.archetype.base.infrastructure.qualifier.Created;
import de.openknowledge.archetype.base.infrastructure.qualifier.Deleted;
import de.openknowledge.archetype.base.infrastructure.qualifier.Updated;
...
public class PersistenceEventEntityListener {
  ...
  public <E extends AbstractEntity> void postPersist(final E entity) {
    ...
    CDI.current()
        .select(new TypeLiteral<Event<E>>() {
