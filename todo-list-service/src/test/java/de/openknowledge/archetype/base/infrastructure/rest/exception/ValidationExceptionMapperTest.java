 ...
 */
package de.openknowledge.archetype.base.infrastructure.rest.exception;

import static org.assertj.core.api.Assertions.assertThat;

import de.openknowledge.archetype.base.infrastructure.domain.entity.AbstractEntity;
import de.openknowledge.archetype.base.infrastructure.domain.error.ApplicationErrorsDTO;
import de.openknowledge.archetype.base.infrastructure.domain.error.ErrorDTO;
import de.openknowledge.archetype.base.infrastructure.validation.TestValueIsNull;
...
public class ValidationExceptionMapperTest {
  ...
  public void toResponse() {
    ...
    Assertions.assertThat(validationError1.getMessage()).isEqualTo("value1 may not be null");

    ErrorDTO validationError2 = validationErrors.get(1);
    Assertions.assertThat(validationError2.getCode()).isEqualTo("VALUE_IS_NULL");
    Assertions.assertThat(validationError2.getMessage()).isEqualTo("value2 may not be null");
  }
